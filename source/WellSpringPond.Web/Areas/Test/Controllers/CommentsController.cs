...
namespace WellSpringPond.Web.Areas.Test.Controllers
{
    public class CommentsController : Controller
    {
        ...
        public async Task<ActionResult> Create([Bind(Include = "Id,CommentText,DatePosted,IsDeleted")] Comment comment)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Edit([Bind(Include = "Id,CommentText,DatePosted,IsDeleted")] Comment comment)
        {
            if (ModelState.IsValid)
            {
